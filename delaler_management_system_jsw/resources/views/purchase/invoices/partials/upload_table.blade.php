    ...
    <table class="table table-hover align-middle mb-0">
        ...
        <tbody>
            ...
            <tr>
                <td class="ps-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <small class="text-muted">Type: Purchase Invoice Upload</small>
                        </div>
                    </div>
                </td>
                ...
                <td>
                    @if($track->failed_rows > 0 || $track->error_log || $track->status == 'failed')
                        <div class="d-flex gap-2">
                            @if($track->error_log)
                                <button class="btn btn-sm btn-outline-danger shadow-sm" type="button" data-bs-toggle="collapse" data-bs-target="#piErrorLog{{ $track->id }}" aria-expanded="false" aria-controls="piErrorLog{{ $track->id }}">
            ...
            @if($track->error_log)
            <tr class="collapse" id="piErrorLog{{ $track->id }}">
            ...
            <tr>
                <td colspan="6" class="text-center py-4 text-muted">
                    ...
                    <p class="mb-0">No purchase invoice upload history found.</p>
                </td>
            </tr>
            @endforelse
        </tbody>
