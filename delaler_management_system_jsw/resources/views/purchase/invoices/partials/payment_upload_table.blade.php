<div class="table-responsive">
    <table class="table table-hover align-middle mb-0">
        ...
        <tbody>
                ...
                <td class="ps-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <small class="text-muted">Type: Purchase Payment Upload</small>
                        </div>
                    </div>
                </td>
                ...
                <td>
                    @if($track->failed_rows > 0 || $track->error_log || $track->status == 'failed')
                        <div class="d-flex gap-2">
                            @if($track->error_log)
                                <button class="btn btn-sm btn-outline-danger shadow-sm" type="button" data-bs-toggle="collapse" data-bs-target="#ppErrorLog{{ $track->id }}" aria-expanded="false" aria-controls="ppErrorLog{{ $track->id }}">
            ...
            @if($track->error_log)
            <tr class="collapse" id="ppErrorLog{{ $track->id }}">
            ...
            <tr>
                <td colspan="6" class="text-center py-4 text-muted">
                    ...
                    <p class="mb-0">No purchase payment upload history found.</p>
                </td>
            </tr>
            @endforelse
        </tbody>
