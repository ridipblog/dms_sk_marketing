    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h4 class="mb-0 fw-bold text-primary">
                <i class="fas fa-chart-line me-2"></i> Dealer Wise Payment Report
            </h4>
            ...
            <div class="row mb-4 g-3">
                <div class="col-md-6 col-lg-6">
                    <div class="card border-0 shadow-sm rounded-3 bg-white h-100">
                        <div class="card-body p-4 d-flex justify-content-between align-items-center">
                            <div>
                                <span class="text-uppercase text-muted fw-bold" style="font-size: 0.75rem; letter-spacing: 0.5px;">Total Transactions</span>
                                <h3 class="fw-bold text-primary my-1" id="cardTotalCount">0</h3>
                                <small class="text-muted"><i class="fas fa-receipt me-1"></i>Filtered Payment Records</small>
                            </div>
                ...
                <div class="col-md-6 col-lg-6">
                    <div class="card border-0 shadow-sm rounded-3 bg-white h-100">
                        <div class="card-body p-4 d-flex justify-content-between align-items-center">
                            <div>
                                <span class="text-uppercase text-muted fw-bold" style="font-size: 0.75rem; letter-spacing: 0.5px;">Total Payment Amount</span>
                                <h3 class="fw-bold text-success my-1" id="cardTotalAmount">₹ 0.00</h3>
                                <small class="text-muted"><i class="fas fa-coins me-1"></i>Combined Transactions Total</small>
                            </div>
...
@if (!isset($errorMessage))
    @push('scripts')
        <script type="module"
            src="{{ asset('js/reports/dealer_payments.js') }}?v={{ config('app.asset_version') }}"></script>
    @endpush
@endif
