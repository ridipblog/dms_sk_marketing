<div class="modal fade" id="uploadDealerModal" tabindex="-1" aria-labelledby="uploadDealerModalLabel"
    aria-hidden="true" data-bs-backdrop="static">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg">
            <div class="modal-header bg-primary text-white border-0">
                <h5 class="modal-title fw-bold" id="uploadDealerModalLabel">
                    <i class="fas fa-file-excel me-2"></i> Upload Dealer Data
                </h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
                    aria-label="Close"></button>
            </div>

            <form id="uploadDealerForm" action="{{ route('dealers.upload.import') }}" method="POST" enctype="multipart/form-data">
                @csrf
