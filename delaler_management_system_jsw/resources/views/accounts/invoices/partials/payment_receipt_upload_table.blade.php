<div class="table-responsive">
    <table class="table table-hover align-middle mb-0">
        ...
        <tbody>
                ...
                <td class="ps-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <small class="text-muted">Type: Payment Receipt Upload</small>
                        </div>
                    </div>
                </td>
                ...
                <td>
                    @if($track->failed_rows > 0)
                        <div class="d-flex gap-2">
                            <button class="btn btn-sm btn-outline-danger shadow-sm" type="button" data-bs-toggle="collapse" data-bs-target="#prErrorLog{{ $track->id }}" aria-expanded="false" aria-controls="prErrorLog{{ $track->id }}">
            ...
            <tr class="collapse" id="prErrorLog{{ $track->id }}">
            ...
            <tr>
                <td colspan="6" class="text-center py-4 text-muted">
                    ...
                    <p class="mb-0">No payment receipt upload history found.</p>
                </td>
            </tr>
            @endforelse
        </tbody>
