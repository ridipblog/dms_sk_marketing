<div class="table-responsive">
    <table class="table table-hover align-middle mb-0">
        ...
        <tbody>
                ...
                <td class="ps-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <small class="text-muted">Type: {{ ucwords(str_replace('_', ' ', $track->upload_type)) }}</small>
                        </div>
                    </div>
                </td>
                ...
                <td>
                    @if($track->failed_rows > 0)
                        <div class="d-flex gap-2">
                            <button class="btn btn-sm btn-outline-danger shadow-sm" type="button" data-bs-toggle="collapse" data-bs-target="#errorLog{{ $track->id }}" aria-expanded="false" aria-controls="errorLog{{ $track->id }}">
                                <i class="fas fa-exclamation-circle me-1"></i> View Summary
                            </button>
            ...
            <tr class="collapse" id="errorLog{{ $track->id }}">
