...
@section('content')
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h4 class="mb-0 fw-bold text-primary">
                <i class="fas fa-file-invoice me-2"></i> Debit Notes
            </h4>
        </div>
        ...
        @else
            <div class="row g-2 mb-4">
                <div class="col-md-4">
                    <div class="d-flex align-items-center">
                        <button class="btn btn-outline-secondary me-2 shadow-sm" id="btnRefreshDebitNotes"
                            title="Refresh List">
                        ...
                        <div class="input-group shadow-sm">
                            ...
                            <input type="text" id="searchDebitNote" class="form-control border-start-0"
                                placeholder="Search by Invoice No or Reason...">
                        </div>
                    </div>
                </div>
                <div class="col-md-5">
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body p-0" id="debitNoteTableContainer">
    ...
    @if (!isset($errorMessage))
        @include('accounts.debit_notes.partials.view_modal')
    @endif
@endsection

@if (!isset($errorMessage))
    @push('scripts')
        <script type="module" src="{{ asset('js/accounts/debit_notes/debit_note.js') }}?v={{ config('app.asset_version') }}">
        </script>
    @endpush
@endif
